jQuery(document).ready(function($) {
    'use strict';
    var this_obj = fitness_crossfit_plugin_activate_plugin;
    ...
    $(document).on('click', '.fitness-crossfit-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message fitness-crossfit-plugin-install');
                button.addClass('button-primary fitness-crossfit-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.fitness-crossfit-recommended-plugins .fitness-crossfit-activation-note').css('display','block');
    ...
    $(document).on('click', '.fitness-crossfit-plugin-activate', function(event) {
    ...
    jQuery('#lite_theme .ibtana-skip-btn').click(function(){
        ...
        jQuery('#lite_theme .fitness-crossfit-recommended-plugins').css('display','none');
    });

    jQuery('#block_pattern .ibtana-skip-btn').click(function(){
        var light_theme = jQuery(this).attr('get-start-tab-id');
        jQuery('.' + light_theme).css('display','block');
        jQuery('#block_pattern .fitness-crossfit-recommended-plugins').css('display','none');
    });
