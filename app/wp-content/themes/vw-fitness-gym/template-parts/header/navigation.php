...
<div class="container">
	<div id="header" class="menubar">
		<div class="header-menu <?php if( get_theme_mod( 'vw_fitness_gym_sticky_header', false) != '' || get_theme_mod( 'vw_fitness_gym_stickyheader_hide_show', false) != '') { ?> header-sticky"<?php } else { ?>close-sticky <?php } ?>">
			<div class="row">
				<div class="align-self-center <?php if( get_theme_mod( 'vw_fitness_gym_search_hide_show',true) != '') { ?>col-lg-8 offset-lg-3 col-md-10 col-6"<?php } else { ?>col-lg-9 offset-lg-3 col-md-12 <?php } ?> ">
